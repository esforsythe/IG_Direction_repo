...
for (x in 1:length(fs)){
  ...
  for (y in 1:length(tGF)){
    ...
    ###NOTE: I changed mc.cores from 24 to 4
    sim_data_list <- mclapply(1:nreps, sim_D_f, nsam=nsam, P1=P1, P2=P2, P3=P3, P4=P4, P31=P31, P32=P32, ms_opts=ms_opts, len=len, scale=scale, subModel=subModel, stats=stats, mc.cores = 4)
